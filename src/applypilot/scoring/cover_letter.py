...
def generate_cover_letter(
    ...
    """
    # Match the resume tailor: aggressive mode relaxes validation so the letter can
    # mirror the JD without tripping fabrication/banned-word gates.
    from applypilot.scoring.tailor import _aggressive_enabled
